...
export const enquiries = pgTable(
  "enquiries",
  {
    ...
    requirementFrequency: text("requirement_frequency").notNull(),
    deliveryCity: text("delivery_city").notNull(),
    deliveryState: text("delivery_state").notNull(),
    pincode: text("pincode"),
    desiredTimeline: text("desired_timeline"),
    message: text("message"),
    labReportPublicId: text("lab_report_public_id"),
    labReportName: text("lab_report_name"),
    labReportMimeType: text("lab_report_mime_type"),
    labReportSizeBytes: integer("lab_report_size_bytes"),
